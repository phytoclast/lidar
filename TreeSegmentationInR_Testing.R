...
setwd("C:/Users/tchobbs/Documents/ArcGIS/Projects/HS_StandExamsLiDAR/OtherData/StandPointClouds")

############### WORKING ON AN INDIVIDUAL TILE ###############

#read in a las file, selecting only needed attributes, and filtering low and high noise...
Las<- readLAS("Stand__5.las", filter="-drop_class 7 18")
...
writeOGR(obj = ttops, dsn = "C:/Users/tchobbs/Documents/ArcGIS/Projects/HS_StandExamsLiDAR/OtherData/StandPointClouds", layer = "Stand_66Ttops_lmf12", driver = "ESRI Shapefile")

#write normalized height las
writeLAS(normLas, "Stand_5_normalized.las", index = FALSE)
...
#write Las file...
writeLAS(las = ElevSegmentedRandomTreeID, file = "Stand__5_ntrees.las")


##############  Batch Processing  ###############

#Build a LASCatalog class to first process a height normalized set of .las files...
norm_ctg<- readLAScatalog("E:/LiDAR/Luzerne/point_cloud/tilecls")

#specify output directory...
opt_output_files(norm_ctg)<- "J:/Huron_NF_LiDAR_Intensity_Normalized/point_cloud/Normalized/{XLEFT}_{YBOTTOM}_height"
